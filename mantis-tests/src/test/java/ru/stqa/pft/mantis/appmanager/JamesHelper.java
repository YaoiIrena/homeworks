...
public class JamesHelper {
    ...
    private void initTelnetSession() {
        ...
        try {
            telnet.connect(mailserver, port); //установка соед. с сервером
    ...
    //посимвольное чтение из данных входн.потока до тех пор, пока не появится соотв. текст
    ...
    private void write(String value) {
        ...
        //ожидание получения письма в почте
